...
module.exports = {
	...
	admin: {
		...
		validEmails: ["n.m.keranova@gmail.com"],
		// set the organization ids you want to be able to log in to the admin website
		validOrgs: [207711849594488]
	},

	// you can generally leave this as-is since it is generated for each new project you created.
	session: {
		encryptionAlgorithm: 'aes256',
		encryptionKey: 'pu+OL6UhgrjrCuFRL7aAXn8OLG4lp0CZT76ZRLH29W0=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'DncndGRotDi49Qkaax7DToyeB7iGnTKYw1DSMiWc80145eT1zLywmEQe9EWoLnoahCWQk1iA6MIsxKeuTnknQg==',
		secret: '/BNafpGeWaN59J7bMsA6o7jdW2X9U5vz', // should be a large unguessable string
	...
	cookieSecret: 'PYfPBoZ0Qx5xIal04/IfZqnO0syz/M7W',
